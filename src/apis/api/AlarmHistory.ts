...
> extends HttpClient<SecurityDataType> {
   ...
   * @name Page6
   * @summary 获取报警历史分页列表
   * @request POST:/alarmHistory/page
   */
  page6 = (

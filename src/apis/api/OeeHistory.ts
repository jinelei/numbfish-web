...
> extends HttpClient<SecurityDataType> {
   ...
   * @name Page21
   * @summary 获取Oee历史分页列表
   * @request POST:/equipment/oeeHistory/page
   */
  page21 = (
    ...
    this.request<PageViewOeeHistoryResponse, any>({
      path: `/equipment/oeeHistory/page`,
      method: 'POST',
      body: data,
